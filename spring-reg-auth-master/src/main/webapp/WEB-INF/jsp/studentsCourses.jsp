...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
    ...
    <!-- Header -->
    <div class="w3-container" id="AllCourses" style="margin-top:75px">
        <h1 class="w3-xxxlarge w3-text-orange"><b>Explore Courses</b></h1>
        <hr style="width:50px;border:5px solid orange" class="w3-round">
        <p>Geek Study - the best place to study</p>
        <p><b>You can choose any of our courses</b>:</p>
    </div>
...
<script type="text/javascript" src="${contextPath}/resources/js/student.js"></script>
