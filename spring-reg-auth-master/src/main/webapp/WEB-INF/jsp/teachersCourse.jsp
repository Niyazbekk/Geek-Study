...
<nav class="w3-sidebar w3-orange w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        <a href="/teachersCourse" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">My Courses</a><sec:authorize access="isAuthenticated()">
...
<script type="text/javascript" src="${contextPath}/resources/js/teacher.js"></script>
