...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
    ...
    <div class="w3-container" id="contact" style="margin-top:75px">
        <h1 class="w3-xxxlarge w3-text-orange"><b>Add Lecture</b></h1>
        <hr style="width:50px;border:5px solid orange" class="w3-round">
        <form id="search-form" action="#" target="_blank">
            <div class="w3-section">
                <label>Lecture</label>
                <input class="w3-input w3-border" id="form-messages" type="text" name="Name" required>
            </div>
            <button type="submit" id="btn-submit" class="w3-button w3-block w3-padding-large w3-orange w3-margin-bottom">Send Message</button>
        </form>
    </div>
...
<script type="text/javascript" src="${contextPath}/resources/js/teacherCourse.js"></script>
